...
return [
    ...
    'title' => 'Stepora API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST v1 pour la boutique Stepora (catalogue, panier, commandes, recherche).',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authentification via <b>Laravel Sanctum</b>. Obtenez un token via <code>POST /api/v1/auth/login</code> puis passez-le en header <code>Authorization: Bearer {token}</code>.',
    ],
