                    ...
                    <select name="category_id" class="admin-select" required>
                        ...
                        @foreach($categories as $parent)
                            <optgroup label="{{ $parent->nom }}">
                                <option value="{{ $parent->id }}" {{ old('category_id', $produit->category_id) == $parent->id ? 'selected' : '' }}>
                                    {{ $parent->nom }} (Général)
                                </option>
                                @foreach($parent->children as $child)
                                    <option value="{{ $child->id }}" {{ old('category_id', $produit->category_id) == $child->id ? 'selected' : '' }}>
                                        -- {{ $child->nom }}
                                    </option>
                                @endforeach
                            </optgroup>
