        ...
        <nav class="admin-nav">
            ...
            <a href="{{ route('admin.messages.index') }}" class="admin-nav-item {{ request()->routeIs('admin.messages.*') ? 'active' : '' }}" style="display: flex; align-items: center;">
                ...
                @if($unreadMessagesCount > 0)
                    <span style="background: #ef4444; color: white; padding: 0.1rem 0.4rem; border-radius: 999px; font-size: 0.7rem; font-weight: bold; margin-left: auto;">{{ $unreadMessagesCount }}</span>
                @endif
            </a>
